...
namespace DigitalRuby.WeatherMaker
{
    ...
    public class WeatherMakerPlayerControllerScript : MonoBehaviour
    {
        ...
        {
            if (WeatherMakerInputHelper.GetKeyDown(KeyCode.M) && !WeatherMakerInputHelper.GetKey(KeyCode.LeftControl) && !WeatherMakerInputHelper.GetKey(KeyCode.RightControl))
            {
            ...
            if (axes == RotationAxes.MouseXAndY)
            {
                ...
                rotationX += WeatherMakerInputHelper.GetAxis("Mouse X") * sensitivityX;
                rotationY += WeatherMakerInputHelper.GetAxis("Mouse Y") * sensitivityY;
        ...
        private void UpdateMovement()
        {
            ...
            if (WeatherMakerInputHelper.GetKey(KeyCode.W))
            {
                transform.Translate(0.0f, 0.0f, speed, Space.Self);
            }
            if (WeatherMakerInputHelper.GetKey(KeyCode.S))
            {
                transform.Translate(0.0f, 0.0f, -speed, Space.Self);
            }
            if (WeatherMakerInputHelper.GetKey(KeyCode.A))
            {
                transform.Translate(-speed, 0.0f, 0.0f, Space.Self);
            }
            if (WeatherMakerInputHelper.GetKey(KeyCode.D))
            {
                transform.Translate(speed, 0.0f, 0.0f, Space.Self);
            }
        }
        ...
        private void Update()
        {
            ...
            {
                if (WeatherMakerInputHelper.GetKeyDown(KeyCode.F))
                {
