...
namespace DigitalRuby.WeatherMaker
{
    ...
    public class WeatherMakerConfigurationScript : MonoBehaviour
    {
        ...
        private void Awake()
        {
            WeatherMakerInputHelper.ConfigureEventSystem(EventSystem);
            WeatherMakerInputHelper.ConfigureEventSystem(UnityEngine.EventSystems.EventSystem.current);
        }
        ...
        private void Update()
        {
            ...
            if (WeatherMakerInputHelper.GetKeyDown(KeyCode.B))
            {
                LightningStrikeButtonClicked();
            }
            if (WeatherMakerInputHelper.GetKeyDown(KeyCode.BackQuote) && (WeatherMakerInputHelper.GetKey(KeyCode.LeftControl) || WeatherMakerInputHelper.GetKey(KeyCode.RightControl)))
            {
            ...
            if (WeatherMakerInputHelper.GetKeyDown(KeyCode.Escape) && WeatherMakerInputHelper.GetKey(KeyCode.LeftShift))
            {
                UnityEngine.SceneManagement.SceneManager.LoadScene(0);
            }
            else if (WeatherMakerInputHelper.GetKey(KeyCode.LeftShift) || WeatherMakerInputHelper.GetKey(KeyCode.RightShift))
            {
                if (WeatherMakerInputHelper.GetKeyDown(KeyCode.Alpha1))
                {
                    UnityEngine.QualitySettings.SetQualityLevel(0, true);
                }
                else if (WeatherMakerInputHelper.GetKeyDown(KeyCode.Alpha2))
                {
                    UnityEngine.QualitySettings.SetQualityLevel(1, true);
                }
                else if (WeatherMakerInputHelper.GetKeyDown(KeyCode.Alpha3))
                {
                    UnityEngine.QualitySettings.SetQualityLevel(2, true);
                }
                else if (WeatherMakerInputHelper.GetKeyDown(KeyCode.Alpha4))
                {
                    UnityEngine.QualitySettings.SetQualityLevel(3, true);
                }
                else if (WeatherMakerInputHelper.GetKeyDown(KeyCode.Alpha5))
                {
                    UnityEngine.QualitySettings.SetQualityLevel(4, true);
                }
                else if (WeatherMakerInputHelper.GetKeyDown(KeyCode.Alpha6))
                {
            ...
            if (WeatherMakerInputHelper.GetKeyDown(KeyCode.F1) && WeatherMakerInputHelper.GetKey(KeyCode.LeftShift))
            {
            ...
            */
            ...
            if (WeatherMapImage != null && Camera.main != null)
            {
                ...
                else if (WeatherMakerInputHelper.GetKeyDown(KeyCode.M) && (WeatherMakerInputHelper.GetKey(KeyCode.LeftControl) || WeatherMakerInputHelper.GetKey(KeyCode.RightControl)))
                {
